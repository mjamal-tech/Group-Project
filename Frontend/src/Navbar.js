...
const Navbar=()=> {
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav ml-auto" style={{float:"right"}}>
      <li class="nav-item">
        <NavLink className="nav-link white" exact to='/login' activeClassName="active">Login</NavLink>
      </li>
      <li class="nav-item">
        <NavLink className="nav-link white" exact to='/register' activeClassName="active">Register</NavLink>
      </li>
      </ul>
    </div>
</nav>
